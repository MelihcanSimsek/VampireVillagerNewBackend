        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VampireNumber = table.Column<int>(type: "integer", nullable: false),
                    PriestNumber = table.Column<int>(type: "integer", nullable: false),
                    WitchNumber = table.Column<int>(type: "integer", nullable: false),
                    VampireHunterNumber = table.Column<int>(type: "integer", nullable: false),
                    ShapeshifterNumber = table.Column<int>(type: "integer", nullable: false),
                    TransformingVampireNumber = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameSettings_Lobbies_LobbyId",
                        column: x => x.LobbyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayType = table.Column<bool>(type: "boolean", nullable: false),
                    PlayerId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Votes_GameSettings_GameSettingId",
